...
#VENDOR_EDIT added by jiachunxu. Our device name have to add PRODUCT_LIST, since we added our own TARGET_PRODUCT
OEM_PRODUCT_LIST := OnePlus
OEM_PRODUCT_LIST += OnePlus2
#EDIT_END
...
#    include vendor/oneplus/oneplus2/$(TARGET_PRODUCT)/BoardConfigVendor.mk
#EDIT_END
  ...
  ifeq ($(wildcard $(QC_PROP_ROOT)/common-noship/etc/device-vendor-noship.mk),)
    ifneq ($(call is-android-codename-in-list,GINGERBREAD HONEYCOMB),true)
      APN_PATH := $(QC_PROP_ROOT)/common/etc

      #ifdef VENDOR_EDIT
      # Aaron 2015-=05-09, Oxygen remove for Tweakker
...
$(call inherit-product-if-exists, $(QC_PROP_ROOT)/qrdplus/Extension/products.mk)
# Include the QRD customer extensions for ChinaMobile.
$(call inherit-product-if-exists, $(QC_PROP_ROOT)/qrdplus/ChinaMobile/products.mk)
# Include the QRD customer extensions for ChinaTelecom.
$(call inherit-product-if-exists, $(QC_PROP_ROOT)/qrdplus/ChinaTelecom/products.mk)
# Include the QRD customer extensions for ChinaUnicom.
$(call inherit-product-if-exists, $(QC_PROP_ROOT)/qrdplus/ChinaUnicom/products.mk)
endif
#endif
...
GPS += libizat_core
GPS += liblbs_core
GPS += location_mq_client
GPS += location_log_util
...
MM_CAMERA += libactuator_dw9761b_camcorder
MM_CAMERA += libactuator_dw9761b_camera
...
#added by zhangxiaowei@camera 20150302 for OTP functions
MM_CAMERA += libmmcamera_ov13860_eeprom
#end of added by zhangxiaowei@camera 20150302 for OTP functions
#end of added by zhangxiaowei@camera 20150310 for qcom OIS architecture
#muyuezhong@camera,2015-4-29,add for ov5648 otp begin
MM_CAMERA += libmmcamera_ov5648_eeprom
#muyuezhong@camera,2015-4-29,add for ov5648 otp end
...
MM_CAMERA += libactuator_bu64244gwz_camera
MM_CAMERA += libactuator_bu64244gwz_camcorder
MM_CAMERA += libchromatix_imx214_common
MM_CAMERA += libchromatix_imx214_cpp_hfr_120
MM_CAMERA += libchromatix_imx214_cpp_hfr_240
...
MM_CAMERA += libchromatix_imx214_hfr_240
...
MM_CAMERA += libchromatix_imx278_common
MM_CAMERA += libchromatix_imx278_cpp_hfr_60
MM_CAMERA += libchromatix_imx278_cpp_liveshot
MM_CAMERA += libchromatix_imx278_cpp_preview
MM_CAMERA += libchromatix_imx278_cpp_snapshot
MM_CAMERA += libchromatix_imx278_cpp_video
MM_CAMERA += libchromatix_imx278_default_video
MM_CAMERA += libchromatix_imx278_hfr_60
MM_CAMERA += libchromatix_imx278_liveshot
MM_CAMERA += libchromatix_imx278_postproc
MM_CAMERA += libchromatix_imx278_preview
MM_CAMERA += libchromatix_imx278_snapshot
...
#muyuezhong@camera,2015-6-26,change for fine tuning begin
MM_CAMERA += libmmcamera_ov5648
MM_CAMERA += libchromatix_ov5648_common
MM_CAMERA += libchromatix_ov5648_15fps_cpp_preview
MM_CAMERA += libchromatix_ov5648_15fps_cpp_snapshot
MM_CAMERA += libchromatix_ov5648_15fps_cpp_liveshot
MM_CAMERA += libchromatix_ov5648_15fps_cpp_video
MM_CAMERA += libchromatix_ov5648_30fps_cpp_preview
MM_CAMERA += libchromatix_ov5648_30fps_cpp_snapshot
MM_CAMERA += libchromatix_ov5648_30fps_cpp_liveshot
MM_CAMERA += libchromatix_ov5648_30fps_cpp_video
MM_CAMERA += libchromatix_ov5648_15fps_video
MM_CAMERA += libchromatix_ov5648_15fps_preview
MM_CAMERA += libchromatix_ov5648_15fps_snapshot
MM_CAMERA += libchromatix_ov5648_15fps_postproc
MM_CAMERA += libchromatix_ov5648_30fps_video
MM_CAMERA += libchromatix_ov5648_30fps_preview
MM_CAMERA += libchromatix_ov5648_30fps_snapshot
MM_CAMERA += libchromatix_ov5648_30fps_postproc
#muyuezhong@camera,2015-6-26,change for fine tuning end
#kangjian add for ov13860
MM_CAMERA += libmmcamera_ov13860
MM_CAMERA += libchromatix_ov13860_common
MM_CAMERA += libchromatix_ov13860_cpp_preview
MM_CAMERA += libchromatix_ov13860_cpp_snapshot
MM_CAMERA += libchromatix_ov13860_cpp_zsl
MM_CAMERA += libchromatix_ov13860_cpp_liveshot
MM_CAMERA += libchromatix_ov13860_cpp_video
MM_CAMERA += libchromatix_ov13860_cpp_hfr
MM_CAMERA += libchromatix_ov13860_default_video
MM_CAMERA += libchromatix_ov13860_quarter_size_video
MM_CAMERA += libchromatix_ov13860_preview
MM_CAMERA += libchromatix_ov13860_snapshot
MM_CAMERA += libchromatix_ov13860_postproc
MM_CAMERA += libchromatix_ov13860_liveshot
MM_CAMERA += libchromatix_ov13860_zsl
MM_CAMERA += libchromatix_ov13860_hfr
MM_CAMERA += libactuator_rohm_bu63165gwl
MM_CAMERA += libactuator_rohm_bu63165gwl_camcorder
MM_CAMERA += libactuator_rohm_bu63165gwl_camera
MM_CAMERA += libactuator_rohm_bu64243gwz
MM_CAMERA += libactuator_rohm_bu64243gwz_camcorder
MM_CAMERA += libactuator_rohm_bu64243gwz_camera
#kangjian add end
...
#muyuezhong@camera,2015-7-7,add for image stable begin
MM_CAMERA += libimage_stability
#muyuezhong@camera,2015-7-7,add for image stable end
...
#MM_CORE
#ifndef VENDOR_EDIT
#niejianan@android, 2015/12/18, Delete qcom no use apk
#MM_CORE := CABLService
#endif /* VENDOR_EDIT */
MM_CORE := libdisp-aba
MM_CORE += libmm-abl
...
SECUREMSM += libSecureSampleAuthClient
...
TOUCH_FUSION += touch_fusion_panel_id_0x0000.cfg
TOUCH_FUSION += max11945.bin
...
ULTRASOUND += libppl
ULTRASOUND += libproxadapter
ULTRASOUND += libproxsockadapter
ULTRASOUND += libqcgesture
ULTRASOUND += libqcproximity
...
ULTRASOUND += ps_tuning1_idle_mtp.bin
ULTRASOUND += ps_tuning1_mtp.bin
ULTRASOUND += ps_tuning1_standby_liquid.bin
ULTRASOUND += ps_tuning1_standby_mtp.bin
ULTRASOUND += readme.txt
ULTRASOUND += sensors.oem
...
ULTRASOUND += service_settings_mtp_1_to_1.xml
ULTRASOUND += service_settings_mtp_folio.xml
ULTRASOUND += sw_calib_liquid.dat
ULTRASOUND += sw_calib_mtp.dat
...
ULTRASOUND += usf_proximity
ULTRASOUND += usf_proximity_apps_mtp.cfg
ULTRASOUND += usf_proximity_mtp.cfg
ULTRASOUND += usf_proximity_mtp_algo_transparent_data.bin
ULTRASOUND += usf_proximity_mtp_rx_transparent_data.bin
ULTRASOUND += usf_proximity_mtp_tx_transparent_data.bin
...
ULTRASOUND += usf_sync_gesture_liquid_algo_transparent_data.bin
...
#endif /* VENDOR_EDIT */
#ifdef VENDOR_EDIT
SNAPDRAGON_SDK_DISPLAY += pp_calib_data_jd35695_1080p_cmd_mode_dsi_panel.xml
#endif
...
# MARE/QBLAS
MARE := libmare-1.0.0
MARE += libmare-cpu-1.0.0
MARE += libQBLAS-0.11.38
...
##ifdef VENDOR_EDIT
##disable Enterprise Security feature from qcom Solution 00029375
...
MM_CAMERA_DBG += libmmcamera_eztune_module
MM_CAMERA_DBG += libmmcamera_eztune_module_32
MM_CAMERA_DBG += libmmcamera_ppbase_module
MM_CAMERA_DBG += libmmcamera_ppbase_module_32
